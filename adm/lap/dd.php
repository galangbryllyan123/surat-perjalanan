...
//nilai
$filenya = "dd.php";
$judul = "[LAPORAN]. Per Dalam Daerah";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
<?php
	...
	//cek
	$qcc1 = mysqli_query($koneksi, "SELECT DISTINCT(tujuan) AS kotanya ".
									"FROM t_spt ".
									"ORDER BY tujuan ASC");
	$rcc1 = mysqli_fetch_assoc($qcc1);
...
<hr>';
    ...
    echo '<form action="'.$filenya.'" method="post" name="formx">';
		...
		echo '<a href="dd_xls.php" target="_blank" title="Print Rekap XLS" class="btn btn-danger"><img src="'.$sumber.'/img/xls.gif" width="16" height="16" border="0">REKAP XLS</a>
