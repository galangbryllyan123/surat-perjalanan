...
//nilai
$filenya = "bulan.php";
$judul = "[LAPORAN]. Per Bagian & Bulan";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if (empty($tahunnya))
	...
	mysqli_query($koneksi, "DELETE FROM lap_bag_bulan ".
	...
	if ($count != 0)
		...
		do {
			...
			for ($k=1;$k<=12;$k++)
				...
				mysqli_query($koneksi, "INSERT INTO lap_bag_bulan(kd, tahun, bulan, ".
											"bagian, total, postdate) VALUES ".
											"('$xyz', '$tahunnya', '$k', ".
