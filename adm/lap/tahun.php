...
//nilai
$filenya = "tahun.php";
$judul = "[LAPORAN]. Per Bagian & Tahun";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
mysqli_query($koneksi, "DELETE FROM lap_bag_tahun");
...
if ($count != 0)
	...
	do {
		...
		for ($k=$tahun-4;$k<=$tahun;$k++)
			...
			//insert
			$xyz = md5("$k$nomer");
			mysqli_query($koneksi, "INSERT INTO lap_bag_tahun(kd, tahun, bagian, total, postdate) VALUES ".
