...
//nilai
$filenya = "jabatan.php";
$judul = "[LAPORAN]. Per Jabatan & Bulan";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if (empty($tahunnya))
	...
	echo '<a href="jabatan_xls.php?tahunnya='.$tahunnya.'" target="_blank" title="Print Rekap XLS" class="btn btn-danger"><img src="'.$sumber.'/img/xls.gif" width="16" height="16" border="0">REKAP XLS</a>
	...
	<thead>
		...
		<th><strong><font color="'.$warnatext.'">NAMA JABATAN</font></strong></th>';
	...
	mysqli_query($koneksi, "DELETE FROM lap_jabatan_bulan ".
	...
	if ($count != 0)
		...
		do {
			...
			for ($k=1;$k<=12;$k++)
				...
				mysqli_query($koneksi, "INSERT INTO lap_jabatan_bulan(kd, tahun, bulan, ".
											"jabatan, total, postdate) VALUES ".
											"('$xyz', '$tahunnya', '$k', ".
