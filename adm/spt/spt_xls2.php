...
$sheet->setCellValue('C37', 'Diusulkan pada tanggal');
...
$sheet->setCellValue('E37', ': '.$e_spt_no.'');
...
$sheet->setCellValue('D39', 'Kepala Bagian Tata Usaha');
$sheet->getStyle('D39')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);
...
$sheet->setCellValue('J39', 'Pejabat Pelaksana Teknis Kegiatan');
$sheet->mergeCells("J39:L39");
$sheet->getStyle('J39:L39')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);
$sheet->setCellValue('J43', ''.$k_nama.','.$k_gelar.'');
$sheet->mergeCells("J43:L43");
$sheet->getStyle('J43:L43')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);
$sheet->setCellValue('J44', 'NIP.'.$k_nip.'');
...
$sheet2 = $excel->getActiveSheet()->setCellValue('B9', '2');
$sheet2 = $excel->getActiveSheet()->setCellValue('C9', 'a');
$sheet2 = $excel->getActiveSheet()->setCellValue('C10', 'b');
$sheet2 = $excel->getActiveSheet()->setCellValue('D9', 'Nama');
$sheet2 = $excel->getActiveSheet()->setCellValue('D10', 'Jabatan');
$sheet2 = $excel->getActiveSheet()->setCellValue('E9', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('E10', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('F9', ''.$yuk_nama.'');
$sheet2->mergeCells("F9:I9");
$sheet2 = $excel->getActiveSheet()->setCellValue('F10', ''.$yuk_jabatan.'');
...
$sheet2 = $excel->getActiveSheet()->setCellValue('B13', 'Untuk');
$sheet2->mergeCells("B13:D13");
$sheet2 = $excel->getActiveSheet()->setCellValue('B14', 'Tujuan');
$sheet2->mergeCells("B14:D14");
$sheet2 = $excel->getActiveSheet()->setCellValue('B15', 'Lamanya');
$sheet2->mergeCells("B15:D15");
$sheet2 = $excel->getActiveSheet()->setCellValue('B16', 'Tanggal Berangkat');
$sheet2->mergeCells("B16:D16");
$sheet2 = $excel->getActiveSheet()->setCellValue('B17', 'Tanggal Kembali');
$sheet2->mergeCells("B17:D17");
$sheet2 = $excel->getActiveSheet()->setCellValue('B18', 'Beban Anggaran');
$sheet2->mergeCells("B18:D18");
...
$sheet2 = $excel->getActiveSheet()->setCellValue('E16', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('E17', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('E18', ':');

$sheet2 = $excel->getActiveSheet()->setCellValue('F13', ''.$e_keperluan.'');
$sheet2->mergeCells("F13:I13");
$sheet2 = $excel->getActiveSheet()->setCellValue('F14', ''.$e_tujuan_akhir.'');
$sheet2->mergeCells("F14:I14");

$e_jml_lamax = $arrangka[$e_jml_lama];

$sheet2 = $excel->getActiveSheet()->setCellValue('F15', ''.$e_jml_lama.' ('.$e_jml_lamax.') hari');
$sheet2->mergeCells("F15:I15");
$sheet2 = $excel->getActiveSheet()->setCellValue('F16', ''.$e_tgl_dari.'');
$sheet2->mergeCells("F16:I16");
$sheet2 = $excel->getActiveSheet()->setCellValue('F17', ''.$e_tgl_sampai.'');
$sheet2->mergeCells("F17:I17");
$sheet2 = $excel->getActiveSheet()->setCellValue('F18', ''.$e_beban.'');
$sheet2->mergeCells("F18:I18");


$sheet2 = $excel->getActiveSheet()->setCellValue('B20', 'Setelah melaksanakan tugas agar segera membuat laporan');
$sheet2->mergeCells("B20:I20");
$sheet2 = $excel->getActiveSheet()->setCellValue('B21', 'Demikian Surat Perintah Tugas ini diberikan untuk dipergunakan sebagaimana mestinya.');
$sheet2->mergeCells("B21:I21");


$sheet2 = $excel->getActiveSheet()->setCellValue('G23', 'Dikeluarkan di');
$sheet2 = $excel->getActiveSheet()->setCellValue('H23', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('I23', ''.$kotanya.'');

$sheet2 = $excel->getActiveSheet()->setCellValue('G24', 'Pada Tanggal');
$sheet2 = $excel->getActiveSheet()->setCellValue('H24', ':');
$sheet2 = $excel->getActiveSheet()->setCellValue('I24', ''.$tanggal.'/'.$bulan.'/'.$tahun.'');

$sheet2 = $excel->getActiveSheet()->setCellValue('G26', 'Mengetahui / Menyetujui');
$sheet2->mergeCells("G26:I26");
$sheet2->getStyle('G26:I26')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);
...
$sheet2 = $excel->getActiveSheet()->setCellValue('G27', 'Sekretaris Daerah');
...
$sheet2 = $excel->getActiveSheet()->setCellValue('G30', ''.$k_nama.','.$k_gelar.'');
$sheet2->mergeCells("G30:I30");
$sheet2->getStyle('G30:I30')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);

$sheet2 = $excel->getActiveSheet()->setCellValue('G31', 'NIP:'.$k_nip.'');
$sheet2->mergeCells("G31:I31");
$sheet2->getStyle('G31:I31')
    ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER)
    -> SetVertical (\PhpOffice\PhpSpreadsheet\Style\Alignment:: VERTICAL_TOP)
    -> setWrapText (true);
...
$sheet3 = $excel->getActiveSheet()->setCellValue('E22', '1. '.$yuk_nama.','.$k_gelar.'');
